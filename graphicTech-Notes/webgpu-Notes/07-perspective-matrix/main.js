...
mat4.scale(transformMatrix, transformMatrix, vec3.fromValues(0.5, 0.5, 0.5))
mat4.rotateX(transformMatrix, transformMatrix, toRadian(30))
mat4.rotateY(transformMatrix, transformMatrix, toRadian(45))
const canvas = document.getElementById('gpuweb')

let perspectiveMatrix = mat4.create()
mat4.perspective(perspectiveMatrix, toRadian(60), 1920 / 1080, 1, 30)
...
async function main() {
  ...
  function render() {
    ...
    mat4.multiply(resultMatrix, perspectiveMatrix, transformMatrix)
    // transformMatrix = mat4.rotateX(transformMatrix, transformMatrix, toRadian(0.5 * deg))

    device.queue.writeBuffer(uniformBuffer, 0, resultMatrix.buffer, resultMatrix.byteOffset, resultMatrix.byteLength)
